//
//  NowMoviesTableTableViewController.swift
//  MovieflixUIKit
//
...
class OldNowMoviesTableViewController: UITableViewController {
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "MovieCell", for: indexPath) as! MovieTableViewCellController
////        let movie = nowPlayingMovies[indexPath.row]
////        cell.update(with: movie)
//        cell.posterImageView.image = UIImage(named: "poster-placeholder")
